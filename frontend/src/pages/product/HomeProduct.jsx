...
import {
  createPayment,
  getPaymentKey,
} from "../../API/PaymentAPI/createPayment";
...
export const HomeProduct = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Home-Page | Apna Shop</title>
        <meta
          name="description"
          content={`Explore Our Home Page Apna Shop. Get the best deals and offers today!`}
        />
        <meta
          name="keywords"
          content={`Home Page, Apna Shop online shopping`}
        />
      </Helmet>
