...
export const AllWishlistPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>My Wishlist | Apna Shop</title>
        <meta
          name="description"
          content="View and manage all the products you’ve added to your wishlist on Apna Shop. Save your favorites for easy shopping anytime."
        />
        <meta
          name="keywords"
          content="wishlist, saved products, favorite items, Apna Shop wishlist"
        />
      </Helmet>
