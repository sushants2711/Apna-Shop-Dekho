...
export const UpdateProfilePage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Update Profile | Apna Shop</title>
                <meta
                    name="description"
                    content="Manage and update your Apna Shop profile. Keep your information up to date for a personalized shopping experience."
                />
                <meta
                    name="keywords"
                    content="update profile, user profile, account settings, Apna Shop"
                />
            </Helmet>
