...
export const deleteAddressController = async (req, res) => {
    try {
        ...
        const deleteAddress = await addressModel.findByIdAndDelete(addressExist._id);
...
export const updateAddressController = async (req, res) => {
    try {
        ...
        const updateData = await addressModel.findByIdAndUpdate(addressExist._id, updateAddress, { new: true });
